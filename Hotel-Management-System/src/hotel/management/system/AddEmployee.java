...
public class AddEmployee extends JFrame{ //Third Frame
	...
	JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddEmployee(){
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/21070320.jpg"));
            JLabel image = new JLabel(i1);
            image.setBounds(360,80,490,380);
            add(image);
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    try {
                        ...
                        String str1="select department from department where department='"+s6+"'";
                        if(str1!=null)
                                {
                                    String str2="update department set budget=budget+"+salary+" where department='"+s6+"'";
                                    c.s.executeUpdate(str2);
                                }
                        else
                        {
                            String str3="insert into department value('"+s6+"','"+salary+"')";
