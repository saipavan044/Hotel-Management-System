...
public class UpdateCheck extends JFrame {
	...
	public UpdateCheck() throws SQLException {
		...
		contentPane.add(lblUpdateCheckStatus);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/1604176512.jpg"));
                JLabel l1 = new JLabel(i1);
                l1.setBounds(420,40,490,400);
                add(l1);
