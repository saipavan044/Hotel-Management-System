...
public class AddDrivers extends JFrame implements ActionListener{
    ...
    public AddDrivers() {
        setBounds(450, 200, 950, 490);
	contentPane = new JPanel();
	setContentPane(contentPane);
	contentPane.setLayout(null);
        
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/123052006.jpg"));
                Image i3 = i1.getImage().getScaledInstance(560,350,Image.SCALE_DEFAULT);
