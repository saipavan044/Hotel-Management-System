...
public class NewCustomer extends JFrame {
	...
	public NewCustomer() throws SQLException {
                ...
                setBounds(650, 200, 1000, 550);
		contentPane = new JPanel();
		setContentPane(contentPane);
		contentPane.setLayout(null);
                
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("hotel/management/system/icons/hotel-credits.png"));
                Image i3 = i1.getImage().getScaledInstance(500,350,Image.SCALE_DEFAULT);
                ImageIcon i2 = new ImageIcon(i3);
                JLabel l1 = new JLabel(i2);
                l1.setBounds(460,70,500,350);
                add(l1);
